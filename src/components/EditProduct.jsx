...
function EditProduct(props) {
    ...
    const findProduct = async () => {
        try {
            const response = await axios.get(`https://backend-rrsk.onrender.com/findProduct/${id}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`https://backend-rrsk.onrender.com/editProduct/${id}`, { name, quantity, price });
